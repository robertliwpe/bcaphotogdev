    ...
    function __construct()
    {
        ...
        // Register the widget using an annonymous function
				add_action( 'widgets_init', function(){
					register_widget( 'ZillaLikes_Widget' );
				});
	}
...
class ZillaLikes_Widget extends WP_Widget {
	...
	public function __construct() {
			parent::__construct(
				'zilla_likes_widget',
				__( 'ZillaLikes', 'zillalikes' ),
				array(
					'classname'   => 'zilla_likes_widget',
					'description' => __( 'Displays your most popular posts sorted by most liked', 'zillalikes' )
				)
			);
		}
