...
class glazov_recent_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'glzv-recent-blog',
      VTHEME_NAME_P . __( ': Recent Posts', 'glazov' ),
      array(
        'classname'   => 'glzv-recent-blog',
        'description' => VTHEME_NAME_P . __( ' widget that displays recent posts.', 'glazov' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $ptypes_field = array(
      ...
      'type' => 'select',
      'options' => 'post_types',
      'default_option' => __( 'Select Post Type', 'glazov' ),
      'title' => __( 'Post Type :', 'glazov' ),
    );
    ...
    $limit_field = array(
      ...
      'type'  => 'text',
      'title' => __( 'Limit :', 'glazov' ),
      'help' => __( 'How many posts want to show?', 'glazov' ),
    );
    ...
    $category_field = array(
      ...
      'type'  => 'text',
      'title' => __( 'Category :', 'glazov' ),
      'help' => __( 'Enter category slugs with comma(,) for multiple items', 'glazov' ),
    );
    ...
    $order_field = array(
      ...
      'default_option' => __( 'Select Order', 'glazov' ),
      'title' => __( 'Order :', 'glazov' ),
    );
    ...
    $orderby_field = array(
      ...
      'options'   => array(
        'none' => __('None', 'glazov'),
        'ID' => __('ID', 'glazov'),
        'author' => __('Author', 'glazov'),
        'title' => __('Title', 'glazov'),
        'name' => __('Name', 'glazov'),
        'type' => __('Type', 'glazov'),
        'date' => __('Date', 'glazov'),
        'modified' => __('Modified', 'glazov'),
        'rand' => __('Random', 'glazov'),
      ),
      'default_option' => __( 'Select OrderBy', 'glazov' ),
      'title' => __( 'OrderBy :', 'glazov' ),
    );
  ...
  public function widget( $args, $instance ) {
    ...
    if ($glazov_rpw->have_posts()) : while ($glazov_rpw->have_posts()) : $glazov_rpw->the_post();
  ?>
  ...
  <li>
    ...
    <?php
      echo get_the_date('d'); esc_html_e( 'th ', 'glazov' );
...
function glazov_recent_posts_function() {
  register_widget( "glazov_recent_posts" );
}
add_action( 'widgets_init', 'glazov_recent_posts_function' );
