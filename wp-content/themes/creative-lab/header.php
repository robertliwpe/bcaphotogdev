...
<?php creative_lab_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php creative_lab_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<div id="middle">
<?php 
creative_lab_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = creative_lab_theme_page_layout_scheme();
