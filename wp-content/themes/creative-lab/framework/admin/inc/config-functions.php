...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['creative-lab' . '_google_web_fonts']) && is_array($cmsmasters_option['creative-lab' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['creative-lab' . '_google_web_fonts'];
		...
		$fonts = array( 
			'' => esc_html__('None', 'creative-lab'), 
			'local' => $local_fonts, 
			'web' => $google_web_fonts 
		);
		
		
		return apply_filters('creative_lab_google_fonts_list_filter', $fonts);
	}
}
...
if (!function_exists('cmsmasters_text_transform_list')) {
	function cmsmasters_text_transform_list() {
		$list = array( 
			...
			'uppercase' => esc_html__('uppercase', 'creative-lab'), 
			'lowercase' => esc_html__('lowercase', 'creative-lab'), 
			'capitalize' => esc_html__('capitalize', 'creative-lab'), 
		);
...
if (!function_exists('cmsmasters_image_thumbnail_list')) {
	function cmsmasters_image_thumbnail_list() {
		$list = creative_lab_get_image_thumbnail_list();
...
if (!function_exists('cmsmasters_color_schemes_list')) {
	function cmsmasters_color_schemes_list() {
		$list = creative_lab_all_color_schemes_list();
