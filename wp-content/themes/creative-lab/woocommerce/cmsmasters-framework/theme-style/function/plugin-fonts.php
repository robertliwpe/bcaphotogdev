...
function creative_lab_woocommerce_fonts($custom_css) {
...
/***************** Start WooCommerce Font Styles ******************/
	...
	.cmsmasters_single_product .cart .quantity input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]) {
		font-size:" . ((int) $cmsmasters_option['creative-lab' . '_content_font_font_size'] + 5) . "px;
	}
	...
	.out-of-stock,
	.stock {
		line-height:" . ((int) $cmsmasters_option['creative-lab' . '_content_font_line_height'] - 4) . "px;
	}
	/* Finish Content Font */
	...
	.shop_table.my_account_orders thead th {
		font-size:" . ((int) $cmsmasters_option['creative-lab' . '_h5_font_font_size'] - 5) . "px;
		line-height:" . ((int) $cmsmasters_option['creative-lab' . '_h5_font_line_height'] - 4) . "px;
	}
	...
	.widget_price_filter .price_slider_amount .button {
		font-size:" . ((int) $cmsmasters_option['creative-lab' . '_button_font_font_size'] - 1) . "px;
		line-height:" . ((int) $cmsmasters_option['creative-lab' . '_button_font_line_height'] - 11) . "px;
	}
	
	.shop_table .actions .button,
	table.variations .reset_variations {
		line-height:" . ((int) $cmsmasters_option['creative-lab' . '_button_font_line_height'] - 4) . "px;
	}
	
	.cmsmasters_single_product .cart .quantity input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]) {
		height:" . ((int) $cmsmasters_option['creative-lab' . '_button_font_line_height'] + 4) . "px;
	}
	/* Finish Button Font */
...
add_filter('creative_lab_theme_fonts_filter', 'creative_lab_woocommerce_fonts');
