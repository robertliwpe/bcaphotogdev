...
function creative_lab_woocommerce_colors($custom_css) {
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.product-category .woocommerce-loop-category__title mark {
	...
	{$rule}.product-category .woocommerce-loop-category__title:hover {
	...
	{$rule}.terms label .input-checkbox + span:after,
	{$rule}.woocommerce-checkout-payment .woocommerce-terms-and-conditions-wrapper .form-row label .input-checkbox + span:after,
	{$rule}.onsale,
	...
	{$rule}.comment-form-rating .stars > span {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_hover']) . ", .4);
	}
	
	{$rule}.link_hover_color {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_hover']) . "
	}
	...
	{$rule}.widget > .product_list_widget del {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .2);
	}
	...
	{$rule}.cmsmasters_dynamic_cart {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .3);
	}
	...
	{$rule}.widget_product_tag_cloud a {
		-webkit-box-shadow:0 0 20px 0 rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", 0.05);
		box-shadow:0 0 20px 0 rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", 0.05);
	}
	...
	{$rule}.terms label .input-checkbox + span:before,
	...
	{$rule}.select2-container.select2-container--open .select2-dropdown--below {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_border']) . "
	}
	
	{$rule}.select2-container.select2-container--open .select2-dropdown--above {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.cmsmasters_added_product_info:after {
		border-bottom:10px solid rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . ", 1);
	}
...
add_filter('creative_lab_theme_colors_secondary_filter', 'creative_lab_woocommerce_colors');
