...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Projects', 'creative-lab');

$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'creative-lab');

$sorting_name_text = ($sorting_name_text != '') ? $sorting_name_text : esc_html__('Name', 'creative-lab');

$sorting_date_text = ($sorting_date_text != '') ? $sorting_date_text : esc_html__('Date', 'creative-lab');
