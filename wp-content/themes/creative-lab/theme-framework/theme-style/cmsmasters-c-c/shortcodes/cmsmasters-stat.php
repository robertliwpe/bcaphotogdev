...
echo '<div id="cmsmasters_stat_wrap_' . esc_attr($unique_id) . '" class="cmsmasters_stat_wrap' . (($this->stats_atts['stats_mode'] == 'circles') ? esc_attr($this->stats_atts['stats_count']) : '') . '">' . "\n" . 
