...
if ($cmsmasters_option['creative-lab' . '_header_top_line']) {
	echo '<div class="header_top" data-height="' . esc_attr($cmsmasters_option['creative-lab' . '_header_top_height']) . '">' . 
		'<div class="header_top_outer">' . 
			'<div class="header_top_inner">';
				...
				if (
					$cmsmasters_option['creative-lab' . '_header_top_line_add_cont'] == 'social' && 
					isset($cmsmasters_option['creative-lab' . '_social_icons'])
				) {
					creative_lab_social_icons();
				} elseif (
					$cmsmasters_option['creative-lab' . '_header_top_line_add_cont'] == 'nav' && 
				...
				if ($cmsmasters_option['creative-lab' . '_header_top_line_short_info'] !== '') {
					echo '<div class="header_top_meta">' . 
						'<div class="meta_wrap">' . 
							stripslashes($cmsmasters_option['creative-lab' . '_header_top_line_short_info']) . 
						'</div>' . 
					'</div>';
				} 
		...
		'<div class="header_top_but closed">' . 
			'<span class="cmsmasters_theme_icon_resp_nav_slide_down"></span>' . 
		'</div>' . 
	'</div>';
}
