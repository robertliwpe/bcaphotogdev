...
function creative_lab_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.widget_tag_cloud a {
		" . cmsmasters_color_css('color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_color']) . "
	}
	...
	{$rule}.cmsmasters_attach_img .cmsmasters_attach_img_meta a {
		" . cmsmasters_color_css('color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters_quotes_grid .cmsmasters_quote_image > span:before {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . ", .7);
	}
	...
	{$rule}.widget_custom_posts_tabs_entries .cmsmasters_tabs .cmsmasters_tabs_list_item a:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . "
	}
	
	{$rule}.cmsmasters_header_search_form {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . ", .95);
	}
	...
	{$rule}.cmsmasters_post_puzzle:hover .puzzle_post_content_wrapper:before {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . "
	}
	...
	@media only screen and (max-width: 1024px) {
		...
		{$rule}.cmsmasters_post_puzzle:nth-child(even):hover .cmsmasters_post_cont .puzzle_post_content_wrapper:before {
			border-bottom-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . ", 1) !important;
		}
	}
	
	{$rule}.cmsmasters_profile_horizontal.style_1 .cmsmasters_profile_img_wrap:before {
		background: -moz-linear-gradient(top,  rgba(0,0,0,0) 0%, rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . ", 1) 100%); /* FF3.6-15 */
		background: -webkit-linear-gradient(top,  rgba(0,0,0,0) 0%,rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . ", 1) 100%); /* Chrome10-25,Safari5.1-6 */
		background: linear-gradient(to bottom,  rgba(0,0,0,0) 0%,rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . ", 1) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
	...
	{$rule}.subpage_nav > span {
		" . cmsmasters_color_css('color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_hover']) . "
	}
	...
	{$rule}.cmsmasters_sitemap_wrap .cmsmasters_sitemap_archive > li a:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . "
	}
	
	{$rule}.cmsmasters_slider_project .cmsmasters_slider_project_cont_info a:hover {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .7);
	}
	...
	{$rule}.cmsmasters_items_filter_wrap .cmsmasters_items_filter_list li.current a:hover {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .5);
	}
	...
	{$rule}.widget_custom_latest_projects_entries .img_placeholder {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . "
	}
	...
	{$rule}.cmsmasters_single_slider.cmsmasters_type_project .owl-buttons > div {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .5);
	}
	
	{$rule}.cmsmasters_slider_project .cmsmasters_slider_project_line {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .2);
	}
	...
	{$rule}.cmsmasters_posts_slider .cmsmasters_slider_post .cmsmasters_slider_post_outer,
	...
	{$rule}.cmsmasters_archive_type {
		-webkit-box-shadow:0 0 20px 0 rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .05);
		box-shadow:0 0 20px 0 rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .05);
	}
	
	{$rule}.portfolio.large_gap.grid .project_outer:hover .preloader img {
		-webkit-box-shadow:0 0 25px 1px rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .2);
		box-shadow:0 0 25px 1px rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", .2);
	}
	
	{$rule}.cmsmasters_profile_horizontal.style_1 .cmsmasters_profile_img_wrap:after {
		background: -moz-linear-gradient(top,  rgba(0,0,0,0) 0%, rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", 1) 100%); /* FF3.6-15 */
		background: -webkit-linear-gradient(top,  rgba(0,0,0,0) 0%,rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", 1) 100%); /* Chrome10-25,Safari5.1-6 */
		background: linear-gradient(to bottom,  rgba(0,0,0,0) 0%,rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_heading']) . ", 1) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
		filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#00413d49', endColorstr='#413d49',GradientType=0 ); /* IE6-9 */
	}
	...
	{$rule}.cmsmasters_icon_box.cmsmasters_icon_box_left:before,
	{$rule}.cmsmasters_icon_box.cmsmasters_icon_box_top:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.widget_custom_latest_projects_entries .cmsmasters_slider_project .cmsmasters_slider_project_outer {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.widget_tag_cloud a {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_alternate']) . "
	}
	
	{$rule}.cmsmasters_post_puzzle .puzzle_post_content_wrapper:before {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_alternate']) . "
	}
	...
	@media only screen and (max-width: 1024px) {
		...
		{$rule}.cmsmasters_post_puzzle:nth-child(even) .cmsmasters_post_cont .puzzle_post_content_wrapper:before {
			border-bottom-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_alternate']) . ", 1) !important;
		}
	}
	...
	{$rule}.commentlist .comment:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.cmsmasters_icon_wrap .cmsmasters_simple_icon {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_border']) . "
	}
	
	{$rule}.owl-pagination .owl-page:hover,
	{$rule}.owl-pagination .owl-page.active {
		-webkit-box-shadow:0 0 0 1px " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_border'] . ";
		box-shadow:0 0 0 1px " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_border'] . ";
	}
	...
	{$rule}.cmsmasters_portfolio_puzzle_style_1 .cmsmasters_project_puzzle .cmsmasters_project_footer a:hover,
	...
	{$rule}.cmsmasters_portfolio_puzzle_style_2 .cmsmasters_project_puzzle .cmsmasters_project_footer a:hover,
	...
	{$rule}.widget_custom_latest_projects_entries .cmsmasters_slider_project_outer:hover .img_placeholder {
		" . cmsmasters_color_css('color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . "
	}
	...
	{$rule}.cmsmasters_post_puzzle:hover .puzzle_post_content_wrapper .cmsmasters_post_cont_info > span.cmsmasters_post_author:before {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . ", .8);
	}
	...
	{$rule}.cmsmasters_slider_project .cmsmasters_slider_project_footer a.active:before {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . ", .7);
	}
	
	{$rule}.cmsmasters_profile_horizontal .cmsmasters_profile_header .cmsmasters_profile_subtitle {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . ", .6);
	}
	...
	{$rule}input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]):hover,
	...
	{$rule}.widget .wp-caption {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . "
	}
	...
	{$rule}.error input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]):focus {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . ", .25);
	}
	...
	{$rule}.cmsmasters_icon_list_items.cmsmasters_color_type_icon .cmsmasters_icon_list_icon:after {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . "
	}
	
	{$rule}.error .error_cont .error_button_wrap .button {
		border-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['creative-lab' . '_' . $scheme . '_secondary']) . ", .25);
	}
	...
	/* Start Secondary Color */
	{$rule}.footer {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['creative-lab_footer' . '_border']) . "
	}
	/* Finish Secondary Color */
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
/***************** Start {$title} Button Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_button.cmsmasters_but_bd_underline:hover {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters_button.cmsmasters_but_icon_divider:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['creative-lab' . '_' . $scheme . '_bg']) . "
	}
...
";
	...
	return apply_filters('creative_lab_theme_colors_primary_filter', $custom_css);
}
