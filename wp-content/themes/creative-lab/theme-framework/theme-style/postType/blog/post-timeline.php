	...
	<div class="cmsmasters_timeline_margin">
		...
		<?php
			if ($cmsmasters_post_format == 'image') {
				...
				creative_lab_post_type_slider(get_the_ID(), $cmsmasters_post_images, 'post-thumbnail', $slider_data);
			} elseif ($cmsmasters_post_format == '' && !post_password_required() && has_post_thumbnail()) {
				creative_lab_thumb(get_the_ID(), 'post-thumbnail', true, false, true, false, true, true, false);
			...
			<div class="cmsmasters_post_cont_inner">
				...
				if ($more || $likes || $comments) {
					echo '<footer class="cmsmasters_post_footer entry-meta">';
						...
						$date ? creative_lab_get_post_date('page', 'timeline') : '';
