	...
	(function ($) { 
		$('.header_top_but').on('click', function () { 
			...
			if (headerTopBut.hasClass('opened')) {
				...
				headerTopButArrow.removeClass('cmsmasters_theme_icon_resp_nav_slide_up').addClass('cmsmasters_theme_icon_resp_nav_slide_down');
				
				headerTopBut.removeClass('opened').addClass('closed');
			} else if (headerTopBut.hasClass('closed')) {
				headerTopOuter.slideDown();
				
				headerTopButArrow.removeClass('cmsmasters_theme_icon_resp_nav_slide_down').addClass('cmsmasters_theme_icon_resp_nav_slide_up');
