	...
	blogContainer.find('.cmsmasters_post_loader').on('click', function () { 
		...
		jQuery.ajax( { 
			...
			success : function (data) { 
				if (data !== '') {
					var newHTML = jQuery(data.replace(/cmsmasters_post_timeline/g, 'cmsmasters_post_timeline cmsmasters_post_timeline_circle shortcode_animated').replace(/cmsmasters_post_masonry/g, 'cmsmasters_post_masonry shortcode_animated')), 
						lightboxVars = [];
					
					
					if (data.slice(0, 6) === 'finish') {
						newHTML = jQuery(data.replace(/cmsmasters_post_timeline/g, 'cmsmasters_post_timeline cmsmasters_post_timeline_circle shortcode_animated').replace(/cmsmasters_post_masonry/g, 'cmsmasters_post_masonry shortcode_animated').slice(6, -1));
