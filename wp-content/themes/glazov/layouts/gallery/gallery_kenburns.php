...
if ($glazov_c_gallery_metabox) {
  ...
  $hide_next_prev = $glazov_c_gallery_metabox['hide_next_prev'];
...
<div class="glzv-full-wrap <?php echo esc_attr($glazov_content_padding); ?>" style="<?php echo esc_attr($glazov_custom_padding); ?>">
  <div class="swiper-container fadeslides keyboard kenburns swiper-style-two">
      ...
      ?>
        <div class="swiper-slide">
          <div class="swiper-slide-wrap">
            <div class="swiper-slide-picture" style="background-image:url(<?php echo esc_url($images); ?>);"></div>
          </div>
        </div>

        <div class="swiper-slide">
          <div class="glzv-slide-wrap">
            <div class="glzv-background <?php echo esc_attr($image_media_class); ?>" style="background-image: url(<?php echo esc_url($images); ?>);"></div>
