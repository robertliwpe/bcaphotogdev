...
<div class="glzv-mid-wrap <?php echo esc_attr($glazov_content_padding); ?>" style="<?php echo esc_attr($glazov_custom_padding); ?>">
  ...
  <div class="glzv-gallery glzv-glry-grid">
    ...
    <?php
        ...
        foreach ($gallery_imagess as $key => $image) {
          ...
          if (!empty( $imagess )) {
            if(class_exists('Aq_Resize')) {
              $images = aq_resize( $imagess[0], '438', '347', true );
        ...
        <div class="masonry-item nature-item" data-category="nature-item">
          <div class="gallery-item">
            <div class="glzv-image <?php echo esc_attr($image_media_class); ?>"><img src="<?php echo esc_url($images); ?>" alt="<?php echo esc_attr($glazov_alt); ?>"></div>
